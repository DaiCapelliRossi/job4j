 ...
 * А также методы для работы банковского приложения
...
public class BankService {
     ...
     * Использован метод, определяющий, что клиента еще нет в списке
     ...
     * Осуществляется проверка, что у пользователя еще нет этого счета
     ...
     * @return user или null, если пользователь не был найден
     */
     ...
     * Затем проходится по счетам клиента и сравнивает его с введенным счетом
     * @param passport паспорт пользователя
