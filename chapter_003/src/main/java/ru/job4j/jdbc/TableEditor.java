...
public class TableEditor implements AutoCloseable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        tableEditor.dropColumn("demo_table", "age");
        System.out.println(tableEditor.getTableScheme("demo_table"));
    ...
    public TableEditor(Properties properties) throws SQLException {
        ...
        initConnection(this.properties.getProperty("url"), this.properties.getProperty("username"), this.properties.getProperty("password"));
    }
